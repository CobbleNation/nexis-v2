...
IMPORTANT: All text must be in Ukrainian.
For metrics, use ONLY Ukrainian units (e.g., "год", "хв", "стор", "км", "кг", "шт", "грн"). Do NOT use English units like "h", "min", "pages", "uah".
`;
