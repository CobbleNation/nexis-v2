                                        ...
                                        return (
                                            <Popover key={entry.item.id}>
                                                <PopoverTrigger asChild>
                                                    <div
                                                        className="absolute text-left outline-none cursor-pointer hover:z-20"
                                                        style={{
                                                            top: entry.top,
                                                    ...
                                                    >
                                                        <motion.div
                                                            ...
                                                            className={cn(
                                                                "w-full h-full rounded-md border flex overflow-hidden transition-all hover:shadow-lg group",
