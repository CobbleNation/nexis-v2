...
import { Loader2, Sparkles, Plus, Check, MessageSquareMore, ChevronUp, ChevronDown, Send, Lock } from 'lucide-react';
        ...
        return (
            <>
                ...
                <UpgradeModal
                    ...
                    title="AI Аналіз Проекту"
                    description="Персональний коуч, який проаналізує ваш проект та запропонує релевантні задачі й метрики. Доступно у Pro версії."
                />
            </>
        );
    }
