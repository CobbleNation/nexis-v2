...
export function MetricUpdateDialog({ open, onOpenChange, metric, entries, color = 'bg-indigo-600' }: MetricUpdateDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md bg-white dark:bg-card border-none shadow-xl rounded-xl overflow-hidden p-0 gap-0 text-foreground">
                            ...
                            <div className="flex gap-4 items-end">
                                <div className="flex-1 space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder={lastEntry ? `${lastEntry.value}` : "0"}
