...
ALTER TABLE `journal_entries` ALTER COLUMN "date" TO "date" integer DEFAULT '"2026-03-14T18:37:55.456Z"';--> statement-breakpoint
...
ALTER TABLE `notes` ALTER COLUMN "date" TO "date" integer DEFAULT '"2026-03-14T18:37:55.456Z"';--> statement-breakpoint
ALTER TABLE `users` ADD `onboarding_completed` integer DEFAULT false;